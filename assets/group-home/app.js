...
(function(){
  ...
  function tile(t){return '<div class="tile"><span class="tg op">En alquiler</span><video autoplay muted loop playsinline preload="none" poster="'+D.cdn+'/'+t[3]+'"><source src="'+D.cdn+'/'+t[2]+'" type="video/mp4"></video><div class="cap">'+t[0]+'<small>'+t[1]+'</small></div></div>';}
