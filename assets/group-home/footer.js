...
(function(){
  ...
  /* social icons in the bottom copyright bar (all pages) */
  (function(){var fw=document.querySelector("footer .wrap");if(fw&&!fw.querySelector(".agmk-foot-social")){fw.insertAdjacentHTML("beforeend",socHTML("agmk-foot-social",18));}})();
