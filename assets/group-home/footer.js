...
(function(){
  ...
  (function(){var fw=document.querySelector("footer .wrap");if(!fw)return;var es=location.pathname.indexOf("/es")===0;var pre=es?"/es":"";var L=es?[["Portfolio",pre+"/portfolio"],["Partners",pre+"/partners"],["Privacidad","/es/privacidad"]]:[["Portfolio","/portfolio"],["Partners","/partners"],["Privacy","/privacy"]];var lg=fw.querySelector(".legal");if(lg&&!fw.querySelector(".agmk-foot-links")){lg.insertAdjacentHTML("afterend",'<nav class="agmk-foot-links">'+L.map(function(x){return '<a href="'+x[1]+'">'+x[0]+'</a>';}).join('')+'</nav>');}if(!fw.querySelector(".agmk-foot-social")){fw.insertAdjacentHTML("beforeend",socHTML("agmk-foot-social",18));}})();
